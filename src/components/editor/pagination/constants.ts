...
export const A4_PAGE_SIZE = getPageSize(1123, 794, 38, 38, 113, 76);
export const A3_PAGE_SIZE = getPageSize(1591, 1123, 38, 38, 113, 76);
export const A5_PAGE_SIZE = getPageSize(794, 419, 38, 38, 113, 76);
